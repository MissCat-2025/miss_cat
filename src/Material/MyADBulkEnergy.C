#include "MyADBulkEnergy.h"

registerMooseObject("MissCatApp", MyADBulkEnergy);

InputParameters
MyADBulkEnergy::validParams()
{
...
MyADBulkEnergy::MyADBulkEnergy(const InputParameters & parameters)
...
void
MyADBulkEnergy::computeQpProperties()
{
